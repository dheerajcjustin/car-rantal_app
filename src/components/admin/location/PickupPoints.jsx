...
const PickupPoints = ({ pickup, backButton }) => {
    const { data, error, isLoading, mutate } = useSWR(`/admin/location/${pickup._id}`, fetcher);
                    ...
                    <Modal onClose={setAddPickupModal}>
                        <div>
                            ...
                            <div className='w-[50vw]'>
                                <LocationMap lat={lat} lng={lng} setLat={setLat} setLng={setLng} />

                            </div >
                            <AddPickup locationId={pickup._id} coords={{ lng, lat }} updatePickup={mutate} />
                        </div>
                    </Modal>
                    :
                    <div>
