...
const AddLocation = ({ onClose, mutate }) => {
  ...
  return (
    ...
    !formShow ? <div className="w-[50vw] rounded-lg p-5  text-banana text-3xl "> Select Location < LocationMap lat={lat} lng={lng} setLat={setLat} setLng={setLng} />
      <div className="w-full flex justify-end ">

        <button className="bg-banana px-5   py-3  rounded-lg text-3xl m-5 text-gray-700 "
      ...
      <div className="bg-[#FDD23F]  w-full  shadow-md rounded px-0  sm:px-8 pt-6 pb-8 mb-4">
        ...
        <ImageUpload image={image} SetImage={SetImage} placeholder="Add Photo" />
        {imgErr && <p> {imgErr}</p>}
