...
import instance from "../../../config/authInstance";
...
const ImageOfCars = ({ carData, onClose }) => {
    ...
    }, [imageFront, imageSide, imageBack, rcImage, pollutionImage, insuranceImage]);
    const imgUpload = () => {
    ...
    return (
        <>
            ...
            <div className=" grid gap-5 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full  ">
                <div className={`${frontErr && 'border-red-600 rounded-2xl border-2'} `}>
                    <ImageUpload
                ...
                <div className={`${backErr && 'border-red-600 rounded-2xl border-2'} `}>
                ...
                <div className={`${sideErr && 'border-red-600 rounded-2xl border-2'} `}>
            ...
            <h3>Documents</h3>
            <div className=" grid gap-5 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full  ">
                <div className={`${rcErr && 'border-red-600 rounded-2xl border-2'} `}>
                ...
                <div className={`${pollutionErr && 'border-red-600 rounded-2xl border-2'} `}>
                ...
                <div className={`${insuranceErr && 'border-red-600 rounded-2xl border-2'} `}>
                    <ImageUpload
