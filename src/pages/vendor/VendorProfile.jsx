    ...
    return (
        <div className=" bg-banana">
            ...
            {otpModal &&
                ...
                <Modal>
                    <OtpVendor mobile={mobile} name={name} vendorId={user.userId} modalOpen={setOtpModal} />
                </Modal>
            }
            <div className=" h-screen   ">
                <div className="mx-auto sm:w-2/3 bg-[#FDD23F] ">
                    ...
                    <div className='flex flex-wrap  justify-center mt-10'>
                        <label className='text-xl w-[60%]' htmlFor="name">Name</label>
                    ...
                    <div className='flex flex-wrap  justify-center mt-10'>
                        <label className='text-xl w-[60%]' htmlFor="mobile">Mobile</label>
                        <input
